...
<head>
  ...
  <title>Edit Daftar Bimbingan BPS Kabupaten/Kota</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard-kabkot.html" class="logo d-flex align-items-center">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="dashboard-kabkot.html">
              <i class="bi bi-grid"></i>
              <span>Dashboard BPS Kab/Kot</span>
            </a>
          </li>
    
          <li class="nav-item">
            <a class="nav-link collapsed" href="mahasiswa-kabkot.html">
          ...
          <li class="nav-item">
            <a class="nav-link collapsed" href="pembimbinglap-kabkot.html">
          ...
          <li class="nav-item">
            <a class="nav-link " href="daftarbimbingan-kabkot.html">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard-kabkot.html">Home</a></li>
          <li class="breadcrumb-item"><a href="daftarbimbingan-kabkot.html">Daftar Bimbingan</a></li>
          <li class="breadcrumb-item"><a href="tabelbimbingan-kabkot.html">Tabel Bimbingan</a></li>
