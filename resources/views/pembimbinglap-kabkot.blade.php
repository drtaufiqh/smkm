...
<head>
  ...
  <title>Pembimbing Lapangan BPS Kabupaten/Kota</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pembimbinglap-kabkot.html">
          ...
          <li class="nav-item">
            <a class="nav-link collapsed" href="daftarbimbingan-kabkot.html">
  ...
  <main id="main" class="main">
    ...
    <div class="text-end">
        <a href="buatpembimbing.html"><button type="button" class="btn btn-success btn">Buat Akun Pembimbing</button></a>
    </div>
