        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ ($mahasiswa->foto) ?? "/storage/assets/img//1701535520_BPS.jpg" }}" alt="Profile" class="rounded-circle">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Mahasiswa</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">{{ $mahasiswa->alamat_1 ?? "-" }}</div>
                    <div class="col-lg-3 col-md-4 label">{{ $mahasiswa->kabKotaAlamat1->nama ?? "Kabupaten/Kota: -" }}</div>
                    <div class="col-lg-2 col-md-4 label">{{ $mahasiswa->kabKotaAlamat1->provinsi->nama ?? "Provinsi: -" }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Alamat Lain di Luar Domisili (Opsional)</div>
                    <div class="col-lg-4 col-md-4">{{ $mahasiswa->alamat_2 ?? "-" }}</div>
                    <div class="col-lg-3 col-md-4 label">{{ $mahasiswa->kabKotaAlamat2->nama ?? "Kabupaten/Kota: -" }}</div>
                    <div class="col-lg-2 col-md-4 label">{{ $mahasiswa->kabKotaAlamat2->provinsi->nama ?? "Provinsi: -" }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Bank</div>
                    <div class="col-lg-9 col-md-8">{{ $mahasiswa->bank ?? "-" }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Atas Nama Bank</div>
                    <div class="col-lg-9 col-md-8">{{ $mahasiswa->an_bank ?? "-" }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">No Rekening</div>
                    <div class="col-lg-9 col-md-8">{{ $mahasiswa->no_rek ?? "-" }}</div>
                  </div>
                </div>
                  ...
                  <form method="POST" action="{{ route('editProfil', ['id' => $mahasiswa->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <img id="fotoPreview" src="{{ ($mahasiswa->foto) ?? "/storage/assets/img//1701535520_BPS.jpg" }}" alt="Profile">
                            <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nama" type="text" class="form-control" id="nama" value="{{ $mahasiswa->nama ?? old('nama') }}" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nim" type="text" class="form-control" id="nim" value="{{ $mahasiswa->nim ?? old('nim') }}" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="kelas" type="text" class="form-control" id="kelas" value="{{ $mahasiswa->kelas ?? old('kelas') }}" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="text" class="form-control" id="email" value="{{ $mahasiswa->email ?? old('email') }}" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="no_hp" type="text" class="form-control" id="no_hp" value="{{ $mahasiswa->no_hp ?? old('no_hp') }}" required>
                      </div>
                    </div>                  
                    ...
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-md-4 col-lg-5">
                          <textarea name="alamat_1" type="area" class="form-control" id="alamat_1" value="" style="height: 137px" required>{{ $mahasiswa->alamat_1 }}</textarea>
                        </div>
                        <div class="col-md-4 mt-lg-0 mt-md-0">
                          <div class="form-floating">
                            <select
                              ...
                              required
                            >
                            @if ($mahasiswa->kabKotaAlamat1)
                                <option value="{{ $mahasiswa->kabKotaAlamat1->id_prov }}">{{ $mahasiswa->kabKotaAlamat1->provinsi->nama }}</option>
                            @else
                          ...
                          <div class="form-floating mt-3">
                            ...
                            >
                            @if ($mahasiswa->kabKotaAlamat1)
                                <option value="{{ $mahasiswa->kabKotaAlamat1->id }}">{{ $mahasiswa->kabKotaAlamat1->nama }}</option>
                            @else
                    ...
                    <div class="row mb-3 mt-3">
                      ...
                      <div class="col-md-4 col-lg-5">
                        <textarea name="alamat_2" type="area" class="form-control" id="alamat_2" value="" style="height: 137px">{{ $mahasiswa->alamat_2 }}</textarea>
                      </div>
                      <div class="col-md-4 mt-lg-0 mt-md-0">
                        <div class="form-floating">
                          <select
                            ...
                            name = "id_prov_2"
                          >
                          @if ($mahasiswa->kabKotaAlamat2)
                              <option value="{{ $mahasiswa->kabKotaAlamat2->id_prov ?? old('id_prov_2') }}">{{ $mahasiswa->kabKotaAlamat2->provinsi->nama }}</option>
                          @else
                              <option value="">Provinsi</option>
                          @endif
                          </select>
                        ...
                        <div class="form-floating mt-3">
                          ...
                          >
                          @if ($mahasiswa->kabKotaAlamat2)
                              <option value="{{ $mahasiswa->kabKotaAlamat2->id ?? old('id_kab_kota_alamat_2') }}">{{ $mahasiswa->kabKotaAlamat2->nama }}</option>
                          @else
                              <option value="">Pilih Provinsi Dahulu</option>
                          @endif
                          </select>
                    ...
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="bank" type="bank" class="form-control" id="bank" value="{{ $mahasiswa->bank ?? old('bank') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="an_bank" type="an_bank" class="form-control" id="an_bank" value="{{ $mahasiswa->an_bank ?? old('an_bank') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="no_rek" type="no_rek" class="form-control" id="no_rek" value="{{ $mahasiswa->no_rek ?? old('no_rek') }}">
                        </div>
                    </div>
