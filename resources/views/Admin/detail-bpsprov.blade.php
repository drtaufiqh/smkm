        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ $bpsprov->foto ?? '/assets/img/BPS.jpg' }}" alt="Profile" class="rounded-circle">
              <h2>BPS Provinsi</h2>
              <h3>{{ $bpsprov->kabKota->provinsi->nama }}</h3>
...
{{-- 
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">{{ $bpsprov->nama }} adalah Badan Pusat Statistik (BPS) yang beroperasi di tingkat provinsi {{ $bpsprov->kabKota->provinsi->nama }}, Indonesia. BPS adalah lembaga pemerintah yang bertanggung jawab untuk mengumpulkan, mengelola, dan menyediakan data statistik resmi untuk wilayah tersebut. Tugas utama {{ $bpsprov->nama }} adalah mengumpulkan data statistik yang mencakup berbagai aspek kehidupan, seperti ekonomi, sosial, demografi, dan lingkungan.</p>

                  <h5 class="card-title">Profil Detail BPS</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Nama Instansi</div>
                    <div class="col-lg-9 col-md-8">{{ $bpsprov->nama }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Provinsi</div>
                    <div class="col-lg-9 col-md-8">{{ $bpsprov->kabKota->provinsi->nama }}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $bpsprov->alamat_lengkap }}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $bpsprov->user->email }}</div>
                  </div>
