...
<form action='{{ url('jadwal_bimbingans/'.$data->id) }}' method='post' enctype="multipart/form-data">
@csrf
@method('PUT')

<div class="my-3 p-3 bg-body rounded shadow-sm">
    <a href="{{ url('jadwal_bimbingans') }}" class="btn btn-secondary"> << Kembali</a>
   ...
   <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <select class="form-control" name='lokasi' value="{{ Session::get('lokasi') }}" id="lokasi">
                ...
                <option value="online" @if ($data->lokasi === "online") selected @endif>online</option>
                <option value="offline" @if ($data->lokasi === "offline") selected @endif>offline</option>
            </select>
        </div>
    </div>
 ...
 <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='link' value="{{ $data->link }}" id="link">
        </div>
    </div>
 ...
 <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='id_dosen_pembimbing' value="{{ $data->id_dosen_pembimbing }}" id="id_dosen_pembimbing">
        </div>
    </div>
