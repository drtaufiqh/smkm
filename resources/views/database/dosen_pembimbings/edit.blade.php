...
<form action='{{ url('/admin/dosen_pembimbings/'.$data->id) }}' method='post' enctype="multipart/form-data">
@csrf
@method('PUT')

<div class="my-3 p-3 bg-body rounded shadow-sm">
    <a href="{{ url('/admin/dosen_pembimbings') }}" class="btn btn-secondary"> << Kembali</a>
