...
<div class="my-3 p-3 bg-body rounded shadow-sm">
      <!-- FORM PENCARIAN -->
      <div class="pb-3">
        <form class="d-flex" action="{{ url('/admin/users') }}" method="get">
      ...
      <!-- TOMBOL TAMBAH DATA -->
      <div class="pb-3">
        <a href='{{ url('/admin/users/create') }}' class="btn btn-primary">+ Tambah Data</a>
      </div>
      ...
      <table class="table table-striped">
          <thead class="text-center align-middle">
              <tr>
                  ...
                  <th class="col-md">email_verified_at</th>
                  <th class="col-md">password</th>
                  <th class="col-md">role</th>
                  <th class="col-md">remember_token</th>
            ...
            @foreach ($data as $item)
              <tr class="align-middle">
                  ...
                  <td class="">
                      ...
                      <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('/admin/users/'.$item->id) }}" method="post">
                        @csrf
                        @method("DELETE")
