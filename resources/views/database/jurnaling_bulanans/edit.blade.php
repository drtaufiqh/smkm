...
<form action='{{ url('jurnaling_bulanans/'.$data->id) }}' method='post' enctype="multipart/form-data">
@csrf
@method('PUT')

<div class="my-3 p-3 bg-body rounded shadow-sm">
    <a href="{{ url('templates-pastikan-ada-s') }}" class="btn btn-secondary"> << Kembali</a>
