  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1 class="text-center">Formulir Pemilihan Lokasi Magang</h1>
      </div>
      <!-- End Page Title -->
            ...
            <form class="row g-3">
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  ...
                  />
                  <label for="floatingName">Link Gmaps Alamat</label>
                </div>
              </div>
              <h5 class="card-title">Prioritas 1</h5>
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <select
                    class="form-select"
              ...
              <h5 class="card-title">Prioritas 2</h5>
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <select
                    class="form-select"
